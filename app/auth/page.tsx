               ...
               <div className="max-w-md w-full space-y-8">
                    ...
                    <div className="text-center">
                         <Link href="/" className="flex items-center justify-center mb-6">
                              <img src="/logo.svg" alt="Ximler Logo" className="h-12 w-auto" />
                         </Link>
                         <h2 className="text-3xl font-bold text-gray-900">{isLogin ? "Welcome back" : "Create your account"}</h2>
                         <p className="mt-2 text-gray-600">{isLogin ? "Sign in to your Ximler account to continue" : "Start building amazing graphics applications with Ximler"}</p>
                    </div>
